...
extern unsigned int getBatteryVoltage();
extern unsigned char chargeLookup(const unsigned int * mv_curve, const unsigned char * charge_curve, unsigned int mv_in);    
